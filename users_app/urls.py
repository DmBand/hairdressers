...
urlpatterns = [
    ...
    # main_profile
    path(
     'registration/', RegistrationUserView.as_view(), name='register'),
    path('login/', LoginUserView.as_view(), name='login'),
    path('logout/', logout_user_view, name='logout'),
    path('add_avatar/', add_avatar_view, name='avatar'),
    path('delete_avatar/<slug:slug_name>/', delete_avatar_view, name='delete_avatar'),
    ...
    path('reset_confirm/<uidb64>/<token>/', ResetPasswordConfirmView.as_view(), name='password_reset_confirm'),
