...
urlpatterns = [
    ...
    # comments
    path('get_comments/<slug:username>/', GetCommentsAPIView.as_view()),
    ...
    path('get_city/<int:city_id>/', GetCityAPIView.as_view()),
    path('get_cities_in_the_region/<int:region_id>/', GetAllCitiesInTheRegion.as_view()),
    # jwt
